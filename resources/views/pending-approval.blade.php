                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Account Pending Approval ⏳</h3>
                                </div>
                                <div class="card-body">
                                    <p>Your registration was successful! However, your account is currently pending admin approval.</p>
                                    <p>Please wait for an administrator to assign you a role before you can access the system.</p>
